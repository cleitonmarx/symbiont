...
import (
	...
	"github.com/cleitonmarx/symbiont/examples/todomailer/internal/usecases/mocks"
...
var (
	...
	restTodo = openapi.Todo{
		...
		EmailAttempts:   domainTodo.EmailAttempts,
		EmailStatus:     openapi.SENT,
		EmailProviderId: domainTodo.EmailProviderID,
