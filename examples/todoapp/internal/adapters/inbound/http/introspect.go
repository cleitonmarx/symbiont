...
var introspectTemplate = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script type="module">
        ...
        async function renderGraph() {
            ...
            const graphDefinition = document.getElementById('graph-data').value;
...
<body>
    <div class="container">
    	...
    	<textarea id="graph-data" style="display:none">%s</textarea>
    </div>
</body>
</html>
`
...
func IntrospectHandler(w http.ResponseWriter, r *http.Request) {
	mermaidGraph, err := depend.ResolveNamed[string]("dependency-graph-mermaid")
	if err != nil {
	...
	_, _ = fmt.Fprintf(w, introspectTemplate, mermaidGraph)
}
