...
// NewMockLLMToolExecutor creates a new instance of MockLLMToolExecutor. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockLLMToolExecutor(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockLLMToolExecutor {
	mock := &MockLLMToolExecutor{}
	mock.Mock.Test(t)
...
// MockLLMToolExecutor is an autogenerated mock type for the LLMToolExecutor type
type MockLLMToolExecutor struct {
	mock.Mock
}

type MockLLMToolExecutor_Expecter struct {
	mock *mock.Mock
}

func (_m *MockLLMToolExecutor) EXPECT() *MockLLMToolExecutor_Expecter {
	return &MockLLMToolExecutor_Expecter{mock: &_m.Mock}
}

// Call provides a mock function for the type MockLLMToolExecutor
func (_mock *MockLLMToolExecutor) Call(context1 context.Context, lLMStreamEventFunctionCall LLMStreamEventFunctionCall, lLMChatMessages []LLMChatMessage) LLMChatMessage {
...
// MockLLMToolExecutor_Call_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Call'
type MockLLMToolExecutor_Call_Call struct {
	*mock.Call
}
...
func (_e *MockLLMToolExecutor_Expecter) Call(context1 interface{}, lLMStreamEventFunctionCall interface{}, lLMChatMessages interface{}) *MockLLMToolExecutor_Call_Call {
	return &MockLLMToolExecutor_Call_Call{Call: _e.mock.On("Call", context1, lLMStreamEventFunctionCall, lLMChatMessages)}
}

func (_c *MockLLMToolExecutor_Call_Call) Run(run func(context1 context.Context, lLMStreamEventFunctionCall LLMStreamEventFunctionCall, lLMChatMessages []LLMChatMessage)) *MockLLMToolExecutor_Call_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockLLMToolExecutor_Call_Call) Return(lLMChatMessage LLMChatMessage) *MockLLMToolExecutor_Call_Call {
	_c.Call.Return(lLMChatMessage)
	return _c
}

func (_c *MockLLMToolExecutor_Call_Call) RunAndReturn(run func(context1 context.Context, lLMStreamEventFunctionCall LLMStreamEventFunctionCall, lLMChatMessages []LLMChatMessage) LLMChatMessage) *MockLLMToolExecutor_Call_Call {
	_c.Call.Return(run)
	return _c
}

// StatusMessage provides a mock function for the type MockLLMToolExecutor
func (_mock *MockLLMToolExecutor) StatusMessage() string {
	ret := _mock.Called()
...
// MockLLMToolExecutor_StatusMessage_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StatusMessage'
type MockLLMToolExecutor_StatusMessage_Call struct {
	*mock.Call
}

// StatusMessage is a helper method to define mock.On call
func (_e *MockLLMToolExecutor_Expecter) StatusMessage() *MockLLMToolExecutor_StatusMessage_Call {
	return &MockLLMToolExecutor_StatusMessage_Call{Call: _e.mock.On("StatusMessage")}
}

func (_c *MockLLMToolExecutor_StatusMessage_Call) Run(run func()) *MockLLMToolExecutor_StatusMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockLLMToolExecutor_StatusMessage_Call) Return(s string) *MockLLMToolExecutor_StatusMessage_Call {
	_c.Call.Return(s)
	return _c
}

func (_c *MockLLMToolExecutor_StatusMessage_Call) RunAndReturn(run func() string) *MockLLMToolExecutor_StatusMessage_Call {
	_c.Call.Return(run)
	return _c
}

// Tool provides a mock function for the type MockLLMToolExecutor
func (_mock *MockLLMToolExecutor) Tool() LLMTool {
	ret := _mock.Called()
	...
	var r0 LLMTool
	if returnFunc, ok := ret.Get(0).(func() LLMTool); ok {
		r0 = returnFunc()
	} else {
		r0 = ret.Get(0).(LLMTool)
	}
	return r0
}

// MockLLMToolExecutor_Tool_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Tool'
type MockLLMToolExecutor_Tool_Call struct {
	*mock.Call
}

// Tool is a helper method to define mock.On call
func (_e *MockLLMToolExecutor_Expecter) Tool() *MockLLMToolExecutor_Tool_Call {
	return &MockLLMToolExecutor_Tool_Call{Call: _e.mock.On("Tool")}
}

func (_c *MockLLMToolExecutor_Tool_Call) Run(run func()) *MockLLMToolExecutor_Tool_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockLLMToolExecutor_Tool_Call) Return(lLMTool LLMTool) *MockLLMToolExecutor_Tool_Call {
	_c.Call.Return(lLMTool)
	return _c
}

func (_c *MockLLMToolExecutor_Tool_Call) RunAndReturn(run func() LLMTool) *MockLLMToolExecutor_Tool_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockLLMToolRegistry) List() []LLMTool {
	ret := _mock.Called()
...
func (_c *MockLLMToolRegistry_List_Call) Return(lLMTools []LLMTool) *MockLLMToolRegistry_List_Call {
	_c.Call.Return(lLMTools)
	return _c
}

func (_c *MockLLMToolRegistry_List_Call) RunAndReturn(run func() []LLMTool) *MockLLMToolRegistry_List_Call {
	_c.Call.Return(run)
	return _c
}
